import { Organization } from 'src/types/index'

export const mockProps: Organization[] = [
  {
    login: 'errfree',
    id: 44,
    ...
    public_members_url:
      'https://api.github.com/orgs/errfree/public_members{/member}',
  ...
  },
  {
    ...
    public_members_url:
      'https://api.github.com/orgs/engineyard/public_members{/member}',
